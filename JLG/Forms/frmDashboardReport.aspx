<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/JLG_Master.Master" AutoEventWireup="true" CodeBehind="frmDashboardReport.aspx.cs" Inherits="JLG.Forms.frmDashboardReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <div class="head-r1x">
            <span id="ReportHeader" runat="server" class="headx"></span>
        </div>
        <div class="block1x form-horizontal">
            ...
            <div class="row">
                <div class="col-sm-12" style="text-align: left; margin-left: 10%">
                    ...
                    <asp:HiddenField ID="hdnRtag" runat="server" />
                    <asp:HiddenField ID="hdnItemDesc" runat="server" />
                    <asp:HiddenField ID="hdnFromDate" runat="server" />
                    <asp:HiddenField ID="hdnToDate" runat="server" />
                    <asp:HiddenField ID="hdnAllData" runat="server" />
                </div>
            </div>
