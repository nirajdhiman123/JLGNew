<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/JLG_Master.Master" AutoEventWireup="true" CodeBehind="frmWIMSInwardReport.aspx.cs" Inherits="JLG.Forms.frmWIMSInwardReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <div class="head-r1x">
            <span class="headx">WIMS Inward Report</span>
        </div>
        <div class="block1x form-horizontal">

            <div class="row" style="margin-bottom: 1%;">
                <div class="col-md-12">
                    <div class="col-sm-4" style="float: left; margin-left: -35px;">
                        <label class="control-label col-sm-4" for="Name">Courier Name:</label>
                        <div class="col-sm-7" style="padding: 0;">
                            <asp:DropDownList ID="ddlCourierName" runat="server" CssClass="form-control" TabIndex="2"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-sm-3">
