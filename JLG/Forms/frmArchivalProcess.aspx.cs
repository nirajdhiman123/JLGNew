...
namespace JLG.Forms
{
    public partial class frmArchivalProcess : System.Web.UI.Page
    {
        ...
        //        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ErrorMessage", "Deleteconfirm('" + txtFormDate.Text.Trim() + "','" + txtFormDate.Text.Trim() + "');", true);
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt = ClsUploadData.GetArchiveData(txtFormDate.Text.Trim(), txtToDate.Text.Trim());

                if (dt != null)
                {
                    if (dt.Rows.Count > 0)
                    {
                        string fname = "PDD Archival Data.xls";
