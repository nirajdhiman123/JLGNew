<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/JLG_Master.Master" AutoEventWireup="true" CodeBehind="frmGroupMaster.aspx.cs" Inherits="JLG.Forms.frmGroupMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <div class="head-r1x">
            <span class="headx">Create Group</span>
        </div>
        <div class="block1x form-horizontal">
            <div class="row">
                        ...
                        <asp:GridView ID="gvUserDetails" runat="server" AutoGenerateColumns="False" BackColor="White"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="S.No." ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="HFUser_Id" runat="server" Value='<%# Bind("GroupId") %>' />
                                ...
                                <asp:TemplateField HeaderText="Edit">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgEdit" runat="server" ImageAlign="Middle"
                                            ImageUrl="~/Images/UI_dataentry.png" ToolTip='<%# Bind("GroupId") %>' OnClick="imgEdit_Click" />
                                    </ItemTemplate>
                                    <ItemStyle Width="50px" HorizontalAlign="Center" />
                                </asp:TemplateField>
                            </Columns>
                ...
                <div class="col-sm-6">
                    <div class="row head-r1x col-sm-9">
                        <label class="control-label" for="Name">User Menu Rights:</label>
                    </div>
                    <div class="row col-sm-8 " style="height: 500px; overflow: auto;margin:3% 5%;">
                        <asp:TreeView ID="tvMenu" runat="server" Height="165px" ShowCheckBoxes="All"
                            NodeWrap="True">
                        </asp:TreeView>
                    </div>
                </div>
