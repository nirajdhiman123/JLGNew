...
namespace JLG.Forms
{
    public partial class frmWIMSInwardReport : System.Web.UI.Page
    {
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //dt = ClsUploadData.GetReportData(txtFormDate.Text.Trim(), txtToDate.Text.Trim(), "INWARD", rdnReportType.SelectedValue.ToString());
                dt = ClsUploadData.GetWIMSInwardReportData(txtFormDate.Text.Trim(), txtToDate.Text.Trim(), ddlCourierName.SelectedValue.ToString());
