<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/JLG_Master.Master" AutoEventWireup="true" CodeBehind="frmParentChildSheet.aspx.cs" Inherits="JLG.Forms.frmParentChildSheet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <div class="head-r1x">
            <span class="headx">Parent Child Sheet</span>
        </div>
        <div class="block1x form-horizontal">
            <div class="row no-gutters">
                <div class="form-group col-sm-3">
                    <label class="control-label col-sm-4" style="padding: 0;">Report Type:</label>
                    <div class="col-sm-7" style="padding: 0;">
                        
                        <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control" Width="130px" AutoPostBack="true" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
